...
import com.niresh23.fanlightcontroller.ui.connection.BleScannerAdapter
import com.niresh23.fanlightcontroller.ui.connection.ConnectionViewModel
import com.niresh23.fanlightcontroller.ui.connection.IBleScanner
...
val AppModule = module {
    ...
    factory<IBleScanner> {
        ...
        BleScannerAdapter(androidContext(), CoroutineScope(dispatcher + SupervisorJob()))
    }
